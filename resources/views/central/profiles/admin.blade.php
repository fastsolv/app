...
<div class="section-header">
  ...
  <div class="section-header-breadcrumb">
    {{-- <div class="breadcrumb-item active"><a href="{{ route('dashboard.index') }}">{{ __('Dashboard') }}</a>
  </div> --}}
    ...
    <div class="col-12 col-md-12 col-lg-4">
      <div class="card profile-widget">
        ...
        <div class="profile-widget-description">
          <div class="profile-widget-name text-capitalize">{{ $user->first_name }} {{ $user->last_name }}</div>
          <div class="ml-2">
            <div>{{ $user->email }}</div>
          </div>
            ...
            <div class="row">
              <div class="form-group col-md-6 col-12">
                ...
                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                  value="{{ old('email', $user->email) }}" autocomplete="name" autofocus>
                @error('email')
                <div class="text-danger pt-1">{{ $message }}</div>
                @enderror
              </div>
