    ...
    <div class="panel panel-primary">
        <div>
            <div class="row text-center">
                <img class="display-img" src="/images/paypal-logo.png" alt="PayPal" /><br>
            </div>
        </div>
        <div>
            <div class="row text-center">
        ...
        <form role="form" action="{{ route('paypal.payment', $pricing->id) }}" method="post">
            @csrf
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <button class="btn btn-primary btn-lg btn-block btn-mt" type="submit">{{ __('Pay Now') }}
