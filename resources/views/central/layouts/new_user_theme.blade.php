    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar user-navbar">
        ...
        <ul class="navbar-nav navbar-right float-right ml-auto">
          <li><a class="nav-link   nav-link-lg nav-link-user" href="{{ route('available_plans.index') }}">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a class="dropdown-item has-icon" href="https://ticketing.expert/saas_docs/1.0.0/" target="_blank"><i class="far fa-question-circle"></i> {{ __('Help') }}</a>
              <div class="dropdown-divider"></div>
