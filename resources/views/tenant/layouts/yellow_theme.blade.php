...
<body>
  <div id="app ">
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar  text-white navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav   navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              ...
              <i class="fas fa-globe-asia mr-1 text-white"></i>
              <div class="d-sm-none d-lg-inline-block text-white">{{ __('Language.') }}</div>
            </a>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user text-white">
              <i class="fa fa-user-circle mr-1 text-white"></i>
              @if (Auth::check())
              <div class="d-sm-none d-lg-inline-block text-white">{{ __('Hi') }}, {{ Auth::user()->name }}</div>
              @endif
            </a>
            <div class="dropdown-menu dropdown-menu-right">
