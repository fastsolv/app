    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('product.update', $uuid) }}">
                        @csrf
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input id="product_name" type="text"
                                        ...
                                        value="{{ old('product_name', $product_name) }}" autocomplete="product_name" autofocus>
                                    @error('product_name')
                            ...
                            <!-- <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <textarea id="product_description" type="text"
                                        ...
                                        name="product_description" autocomplete="product_description"
                                        autofocus>{{ old('product_description', $product_description) }}</textarea>
