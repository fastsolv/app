                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped" id="table-1">
                            <thead>
                                ...
                                <th><a  class ="text-secondary text-decoration-none font-weight-bold" href="{{ route('get_faqs',['name' => 'category_id' ,'order'=>$sort_order]) }}">{{ __('Category') }}
                                        ...
                                        <th><a  class ="text-secondary text-decoration-none font-weight-bold" href="{{ route('get_faqs',['name' => 'name' ,'order'=>$sort_order]) }}">{{ __('Name') }}
                                        <span> @if($sort_order =='asc')
                                                <i  class=" fa fa-sort-alpha-up mt-1 float-right  "></i>
                                                    @else
                                                    <i  class=" mt-1 float-right   fa fa-sort-alpha-down  "></i>
