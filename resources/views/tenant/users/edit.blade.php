...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">{{ __('Modify User') }}</div>
    </div>
</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update', $id) }}">
                        ...
                        <div>
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input id="name" type="text"
                                        ...
                                        value="{{ old('name', $first_name) }}" autocomplete="name" autofocus>
                                    @error('name')
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input id="email" type="email"
                                        ...
                                        value="{{ old('email', $email) }}" autocomplete="name" autofocus>
                                    @error('email')
                                    <div class="text-danger pt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                <label for="language_id" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('Language') }}:</label>
                                <div class="col-sm-12 col-md-7">
                                <select class="form-control" id="language_id" name="language_id">
                                    @foreach ($languages as $language)
                                        <option value="{{ $language->id }}"@if ($language_id == $language->id) selected @endif>
                                            {{ $language->language }}
                                        </option>
                                    @endforeach
                                </select>
