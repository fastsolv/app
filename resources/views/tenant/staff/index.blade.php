...
<div class="section-header shadow-none">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">{{ __('List of Staffs') }}</div>
    </div>
</div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped" id="table-1">
                            <thead>
                                ...
                                <th><a  class ="text-secondary text-decoration-none font-weight-bold" href="{{ route('get_staffs',['name' => 'name' ,'order'=>$sort_order]) }}">{{ __('Name') }} 
                                        ...
                                        <th><a  class ="text-secondary text-decoration-none font-weight-bold" href="{{ route('get_staffs',['name' => 'email' ,'order'=>$sort_order]) }}">{{ __('Email') }} 
                                        <span> @if($sort_order =='asc') 
                                                <i  class=" fa fa-sort-alpha-up mt-1 float-right  "></i>
                                                    @else
                                                    <i  class=" mt-1 float-right   fa fa-sort-alpha-down  "></i>
