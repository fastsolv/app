...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">{{ __('Email Tickets Assigned To Me') }}</div>
    </div>
</div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="inline-block">{{ __('Email Tickets Assigned To Me') }}</h4>
                </div>
                <div class="card-body">
                    <form action="/email_assigned_to_me" method="get">
                        @csrf
