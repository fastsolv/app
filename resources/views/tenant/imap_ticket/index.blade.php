                        ...
                        <table class="table table-striped pt-3" id="table-1">
                            <thead>
                                ...
                                <th><a  class ="text-secondary text-decoration-none font-weight-bold" href="{{ route('get_imap_ticket',['name' => 'tid' ,'order'=>$sort_order]) }}">{{ __('Ticket ID') }} 
                                    ...
                                    <th><a  class ="text-secondary text-decoration-none font-weight-bold" href="{{ route('get_imap_ticket',['name' => 'subject' ,'order'=>$sort_order]) }}">{{ __('Subject') }} 
                                        <span> @if($sort_order =='asc') 
                                                <i  class=" fa fa-sort-alpha-up mt-1 float-right  "></i>
                                                    @else
                                                    <i  class=" mt-1 float-right   fa fa-sort-alpha-down  "></i>
                                    ...
                                    <th><a  class ="text-secondary text-decoration-none font-weight-bold" href="{{ route('get_imap_ticket',['name' => 'from_name' ,'order'=>$sort_order]) }}">{{ __('customer') }} 
                                        <span> @if($sort_order =='asc') 
                                                <i  class=" fa fa-sort-alpha-up mt-1 float-right  "></i>
                                                    @else
                                                    <i  class=" mt-1 float-right   fa fa-sort-alpha-down  "></i>
                            ...
                            <tbody>
                                ...
                                <tr class="bg-table-custom font-weight-bold-custom">
                                    <td>
                                        <a class=""
                                        href="{{ route('imap_ticket.reply', [$ticket->uuid]) }}">#{{ $ticket->tid}} </a>
                                    </td>
