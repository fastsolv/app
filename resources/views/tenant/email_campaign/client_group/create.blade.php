...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">{{ __('Add Email Campaign') }}</div>
    </div>
</div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('Add Client Group Email Campaign') }}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('client_group_campaign.store') }}">
                        @csrf
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control selectric" id="client_group" name="client_group_id">
                                        ...
                                        @if (old('client_group_id') == $client_group->uuid)
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control selectric" id="template" name="template_id">
                                        ...
                                        @if (old('template_id') == $template->uuid)
                            ...
                            <div class="form-group row mb-4" id="send_at">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input name="send_at" type="text" class="form-control datetimepicker"
                                        value={{ old('send_at', $current_time) }}>
                                </div>
                            </div>
