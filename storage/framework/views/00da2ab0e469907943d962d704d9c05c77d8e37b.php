    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('admin_settings.update', $id)); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    name="name" value="<?php echo e(__($name)); ?>" autocomplete="name" autofocus readonly>
...
unset($__errorArgs, $__bag); ?>"
                                    name="text" value="<?php echo e(old('text', $value)); ?>" autocomplete="text" autofocus>
...
<?php echo $__env->make('central.layouts.new_theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/app/resources/views/central/settings/text.blade.php ENDPATH**/ ?>