    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar user-navbar">
        ...
        <ul class="navbar-nav navbar-right float-right ml-auto">
          <li><a href="<?php echo e(route('plan_details.index')); ?>"
              class="nav-link nav-link-lg nav-link-user">
              <i class="fas fa-coins mr-1"></i>
              <div class="d-sm-none d-lg-inline-block"><?php echo e(__('Pricing')); ?></div>
            </a>
          </li>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              ...
              <div class="d-sm-none d-lg-inline-block"><?php echo e(__('User')); ?></div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              

              <a href="<?php echo e(route('login')); ?>" class="dropdown-item has-icon">
                <i class="far fa-user"></i> <?php echo e(__('Login')); ?>

              </a>

              <div class="dropdown-divider"></div>
              <a href="<?php echo e(route('register')); ?>" class="dropdown-item has-icon">
                <i class="far fa-user"></i> <?php echo e(__('Register')); ?>
...
</html><?php /**PATH /srv/app/resources/views/central/layouts/public_white.blade.php ENDPATH**/ ?>