...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><?php echo e(__('Add User')); ?></div>
    </div>
</div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="inline-block"><?php echo e(__('Add User')); ?></h4>
                </div>
...
unset($__errorArgs, $__bag); ?>"
                                    name="email" value="<?php echo e(old('email')); ?>" autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>"
                                    name="phone" value="<?php echo e(old('phone')); ?>" autocomplete="email">
...
unset($__errorArgs, $__bag); ?>" name="password"
                                    value="<?php echo e(old('password')); ?>" autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="c_password"
                                    value="<?php echo e(old('c_password')); ?>" autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" id="address_1"
                                    ...
                                    autofocus><?php echo e(old('address_1')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="address_2"
                                    ...
                                    autofocus><?php echo e(old('address_2')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="postal_code"
                                    value="<?php echo e(old('postal_code')); ?>" autocomplete="postal_code">
...
<?php echo $__env->make('central.layouts.new_theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/app/resources/views/central/users/create.blade.php ENDPATH**/ ?>