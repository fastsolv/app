                ...
                <div class="card-body">
                        ...
                        <form action="/ticket" method="get">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" name="search" class="form-control search-bar-input"
                                    placeholder="<?php echo e(__('Search')); ?>" value="<?php echo e(request()->input('search')); ?>">
                    ...
                    <div class="table-responsive pt-1">
                        ...
                        <div class="empty-state pt-3" data-height="400">
                            ...
                            <a href="<?php echo e(route('ticket.create')); ?>" class="btn btn-custom mt-4"><?php echo e(__('Create new One')); ?></a>
                        </div>
                        <?php else: ?>
                        <table class="table table-striped pt-3" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr class="">
                                    <td>
                                        <a class=""
                                        href="<?php echo e(route('ticket.reply', [$ticket->uuid])); ?>">#<?php echo e($ticket->tid); ?> </a>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <a class=""
                                        href="<?php echo e(route('ticket.reply', [$ticket->uuid])); ?>">#<?php echo e(Str::limit($ticket->tid, 30)); ?> </a>
                                    </td>
...
<?php echo $__env->make( 
    ...
    , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/app/resources/views/tenant/ticket/user/index.blade.php ENDPATH**/ ?>