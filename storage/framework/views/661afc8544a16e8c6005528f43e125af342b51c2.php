...
<div class="section-body">
  ...
  <?php echo $__env->make('common.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="col-12 col-md-12 col-lg-5">
      <div class="card profile-widget">
        ...
        <div class="profile-widget-description">
          <div class="profile-widget-name text-capitalize"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>

            <?php if($user->status_id == 1): ?>
            <div class="text-success d-inline float-right mr-2">
              <?php echo e(__($user->statuses->name)); ?>
      ...
      <div class="card">
        <div class="card-header">
          <h4><?php echo e(__('Active plan')); ?></h4>
        </div>
        <div class="card-body">
          <?php if($service == null): ?>
          <h5 class="card-title text-danger"><?php echo e(__('No active plans')); ?></h5>
          <?php else: ?>
          <h5 class="text-capitalize"><?php echo e(__('Plan name')); ?>: <?php echo e(__($service->plans->name)); ?> <?php echo e(__('for')); ?>

            <?php echo e(__($service->pricing->term)); ?> <?php echo e(__($service->pricing->period)); ?></h5>
          <p class="card-text"><?php echo e(__('Plan status')); ?>:
            <?php if($service->statuses->name == 'active' && $service->orders->status == "active"): ?>
            <span class="text-capitalize text-success"><?php echo e(__($service->statuses->name)); ?></span>
            <?php elseif($service->statuses->name == 'active' && $service->orders->status !== "active"): ?>
            <span class="text-capitalize text-danger"><?php echo e(__("Order is not confirmed")); ?></span>
            <?php else: ?>
            <span class="text-capitalize text-danger"><?php echo e(__("Inactive")); ?></span>
            <?php endif; ?>
          </p>
          <p class="card-text"><?php echo e(__('Expiry date')); ?>:
            <span class="font-weight-bold"><?php echo e(\Carbon\Carbon::parse($service->expiry_date)->format('d-M-Y')); ?></span>
          </p>
          <?php endif; ?>
        </div>
      </div>
...
unset($__errorArgs, $__bag); ?>" name="email"
                  value="<?php echo e(old('email', $user->email)); ?>" autocomplete="name" autofocus readonly>
...
<?php echo $__env->make('central.layouts.new_user_theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/app/resources/views/central/profiles/user.blade.php ENDPATH**/ ?>