    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar user-navbar">
        ...
        <ul class="navbar-nav navbar-right float-right ml-auto">
          <li><a class="nav-link   nav-link-lg nav-link-user" href="<?php echo e(route('available_plans.index')); ?>">
              <i class="fa fa-database mr-1" aria-hidden="true"></i>
              <div class="d-sm-none d-lg-inline-block"><?php echo e(__('Plans')); ?></div>
            </a>
          </li>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a class="dropdown-item has-icon" href="https://ticketing.expert/saas_docs/1.0.0/" target="_blank"><i class="far fa-question-circle"></i> <?php echo e(__('Help')); ?></a>
              <div class="dropdown-divider"></div>
...
</html><?php /**PATH /srv/app/resources/views/central/layouts/new_user_theme.blade.php ENDPATH**/ ?>