        ...
        <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <h4 class="inline-block"><?php echo e(__('Register')); ?></h4>
...
unset($__errorArgs, $__bag); ?>" name="first_name"
                                    value="<?php echo e(old('first_name')); ?>"  autocomplete="first_name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="last_name"
                                    value="<?php echo e(old('last_name')); ?>"  autocomplete="last_name" autofocus>
...
<?php echo $__env->make( 
    ...
    , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/app/resources/views/tenant/auth/register.blade.php ENDPATH**/ ?>