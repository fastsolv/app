      ...
      <nav class="navbar  text-white navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav   navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              ...
              <div class="d-sm-none d-lg-inline-block text-white"><?php echo e(__('Language.')); ?></div>
            </a>
...
<?php /**PATH /srv/app/resources/views/tenant/layouts/black_theme.blade.php ENDPATH**/ ?>