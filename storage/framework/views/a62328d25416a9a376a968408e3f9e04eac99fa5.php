...
<div class="section-header shadow-none ">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><?php echo e(__('Products')); ?></div>
    </div>
</div>
                        ...
                        <table class="table table-striped" id="table-1">
                            <thead>
                                <tr class="text-center text-capitalize">
                                    <th> <a  class ="text-secondary text-decoration-none font-weight-bold" href="<?php echo e(route('products',['name' => 'product_name' ,'order'=>$sort_order])); ?>"><?php echo e(__('Product Name')); ?>
                                    ...
                                    <th> <a  class ="text-secondary text-decoration-none font-weight-bold" href="<?php echo e(route('products',['name' => 'product_description' ,'order'=>$sort_order])); ?>"><?php echo e(__('Product Description')); ?> 
                                         <span> <?php if($sort_order =='asc'): ?> 
                                            <i  class=" fa fa-sort-alpha-up mt-1 float-right  "></i>
                                             <?php else: ?>
                                             <i  class=" mt-1 float-right   fa fa-sort-alpha-down  "></i>
                                    ...
                                    <th><a  class ="text-secondary text-decoration-none font-weight-bold" href="<?php echo e(route('products',['name' => 'status' ,'order'=>$sort_order])); ?>"><?php echo e(__('Status')); ?> 
                                        <span> <?php if($sort_order =='asc'): ?> 
                                                <i  class=" fa fa-sort-alpha-up mt-1 float-right  "></i>
                                                    <?php else: ?>
                                                    <i  class=" mt-1 float-right   fa fa-sort-alpha-down  "></i>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-capitalize"><?php echo e($product->product_name); ?></td>
                                    ...
                                    <td class="justify-content-center form-inline">
                                        ...
                                        <a href="<?php echo e(route('product.edit', [$product->uuid])); ?>"
                                        ...
                                        <form action="<?php echo e(route('product.destroy', [$product->uuid])); ?>"
                                            method="POST">
...
<?php echo $__env->make( 
   ...
   ( ($theme =="blue") ?'tenant.layouts.blue_theme': 'tenant.layouts.yellow_theme' ))))
    , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/app/resources/views/tenant/products/index.blade.php ENDPATH**/ ?>