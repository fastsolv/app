            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content pt-3" id="myTabContent">
                        <a href="<?php echo e(route('pricing_create', [$plan_id])); ?>"
                            class="btn btn-custom mb-2 float-right add_button"><?php echo e(__('Add')); ?></a>
                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-capitalize">
                                        <td><?php echo e(__($price->term)); ?></td>
                                        <td><?php echo e(__($price->period)); ?></td>
                                        <td><?php echo e(__($price->currencies->prefix)); ?><?php echo e(__($price->price)); ?> <?php echo e(__($price->currencies->currency)); ?></td>
                                        <td class="justify-content-center form-inline">
                                            <a href="<?php echo e(route('pricing_edit', [$price->id, $price->plans->uuid])); ?>"
                                                class="btn btn-sm bg-transparent"><i class="far fa-edit text-primary"
                                                    aria-hidden="true" title="<?php echo e(__('Edit')); ?>"></i></a>
                                            <form action="<?php echo e(route('pricing.destroy', [$price->id])); ?>" method="POST">
...
<?php echo $__env->make('central.layouts.new_theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/app/resources/views/central/pricing/index.blade.php ENDPATH**/ ?>