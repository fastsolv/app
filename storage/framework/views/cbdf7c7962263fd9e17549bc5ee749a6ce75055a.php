...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><?php echo e(__('Add Currency')); ?></div>
    </div>
</div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><?php echo e(__('Add Currency')); ?></h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('currency.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="currency"
                                        value="<?php echo e(old('currency')); ?>" autocomplete="currency">
...
unset($__errorArgs, $__bag); ?>" name="prefix"
                                        value="<?php echo e(old('prefix')); ?>" autocomplete="prefix">
...
<?php echo $__env->make('central.layouts.new_theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/app/resources/views/central/currency/create.blade.php ENDPATH**/ ?>